...
import com.wfusion.baseland.estimate.EstimateReport5Model;
...
public class EstimateReport5Controller {
    @FXML
    private AnchorPane report5;
    @FXML
    ...
    EstimateReport5Model model = new EstimateReport5Model();
    ...
    ChangeListener<Boolean> lostFocusListener = new ChangeListener<Boolean>(){
        ...
        public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
            if (!bl2.booleanValue()) {
                EstimateReport5Controller.this.reCal();
            }
        }
    };
    ...
    public void init(BaseLandDialog baseLandDialog, final EstimateController estimateController) {
        ...
        this.cs081.textProperty().addListener((ChangeListener)new ChangeListener<String>(){
            ...
            public void changed(ObservableValue<? extends String> observableValue, String string, String string2) {
                ...
                String string4 = (String)EstimateReport5Controller.this.cbMonth.getSelectionModel().getSelectedItem();
                String string5 = DateTime.m2y(string3, string4);
                EstimateReport5Controller.this.model.voValue.put("cs08", StringProcess.parserDouble(string5));
                EstimateReport5Controller.this.cs08.setValue(string5);
            }
        });
        this.cs02.textProperty().addListener((ChangeListener)new ChangeListener<String>(){

            public void changed(ObservableValue<? extends String> observableValue, String string, String string2) {
                if (!EstimateReport5Controller.this.isFirstRefresh && !StringProcess.isEmpty(string2)) {
                    if (EstimateReport5Controller.this.cs05.getSelectionModel().getSelectedItem() != null && !StringProcess.isEmpty(((OptionPair)EstimateReport5Controller.this.cs05.getSelectionModel().getSelectedItem()).getValue())) {
                        int n = EstimateReport5Controller.this.getInstruStdPrice(((OptionPair)EstimateReport5Controller.this.cs05.getSelectionModel().getSelectedItem()).getValue(), StringProcess.parserInt(string2));
                        EstimateReport5Controller.this.cs28.setValue(String.valueOf(n));
                    }
                    EstimateReport5Controller.this.reCal();
                }
            }
        ...
        this.cs30.focusedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (EstimateReport5Controller.this.havebuildY.isSelected()) {
                    String string = EstimateReport5Controller.this.cs30.getValue().toString();
                    if (bl2.booleanValue() && !StringProcess.isEmpty(string)) {
                        this.oldDate = string;
                    }
                    if (!(EstimateReport5Controller.this.isFirstRefresh || bl2.booleanValue() || StringProcess.isEmpty(string))) {
                        if (!this.oldDate.equals(string)) {
                            if (BaseLandVerifyUtil.checkDate(string, EstimateReport5Controller.this.notEmpty)) {
                                double d = new EstimateModel().getAdjustRatio(string);
                                EstimateReport5Controller.this.cs29.setValue(NumberFormater.df2.format(d));
                                EstimateReport5Controller.this.lbPrompt.setVisible(false);
                                EstimateReport5Controller.this.reCal();
                            } else {
                                JavaFXUtil.showToastMessageBox(estimateController.dialog.getStage(), "\u4ea4\u6613\u65e5\u671f\u683c\u5f0f\u932f\u8aa4", 500);
                                EstimateReport5Controller.this.cs30.setValue("");
                                EstimateReport5Controller.this.lbPrompt.setVisible(true);
                            }
                        }
                    } else {
                        EstimateReport5Controller.this.lbPrompt.setVisible(true);
    ...
    private void initTextField() {
        String string = EstimateModel.BASELANDBEAN.voSell_3.getTableName().toUpperCase();
        for (Node node : this.report5.getChildren()) {
            String[] stringArray2;
            Object object;
    ...
    private void initCombox() {
        this.dist.getSelectionModel().selectedItemProperty().addListener((observableValue, optionPair, optionPair2) -> {
            ...
            if (optionPair2 != null && !StringProcess.isEmpty(optionPair2.getValue())) {
                ...
                EstimateModel.BASELANDBEAN.voAppRaA3Vo3.setDist(optionPair2.getValue());
            }
        });
        this.aa48.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<OptionPair>(){
            ...
            public void changed(ObservableValue<? extends OptionPair> observableValue, OptionPair optionPair, OptionPair optionPair2) {
                try {
                    if (optionPair != null) {
                        EstimateReport5Controller.this.updateLandPosition();
                    }
                    if (optionPair2 != null && !StringProcess.isEmpty(optionPair2.getValue())) {
                        EstimateReport5Controller.this.model.voValue.put("aa48", optionPair2.getValue());
                    }
                }
        ...
        this.cs05.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<OptionPair>(){
            ...
            public void changed(ObservableValue<? extends OptionPair> observableValue, OptionPair optionPair, OptionPair optionPair2) {
                if (EstimateReport5Controller.this.isFirstRefresh || optionPair2 == null) {
                    return;
                }
                EstimateReport5Controller.this.model.voValue.put("cs05", optionPair2.getValue());
                NVO_BASELAND_INSTRU nVO_BASELAND_INSTRU = SQLiteDataProviderModel.getMAPINSTRU().get(optionPair2.getValue());
                EstimateReport5Controller.this.cs24.setValue(String.valueOf(nVO_BASELAND_INSTRU.getYear_limits()));
                EstimateReport5Controller.this.cs26.setValue(String.valueOf(nVO_BASELAND_INSTRU.getResidual_rate()));
                String string = EstimateReport5Controller.this.cs02.getValue().toString();
                if (!StringProcess.isEmpty(string)) {
                    int n = EstimateReport5Controller.this.getInstruStdPrice(optionPair2.getValue(), StringProcess.parserInt(string));
                    EstimateReport5Controller.this.cs28.setValue(String.valueOf(n));
                }
                EstimateReport5Controller.this.reCal();
            }
        ...
        this.cbMonth.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<String>(){
            ...
            public void changed(ObservableValue<? extends String> observableValue, String string, String string2) {
                String string3 = EstimateReport5Controller.this.cs081.getValue().toString();
        ...
        this.cs21.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<String>(){
            ...
            public void changed(ObservableValue<? extends String> observableValue, String string, String string2) {
                String string3 = string2;
                EstimateReport5Controller.this.model.voValue.put("cs21", string3);
                EstimateReport5Controller.this.reCal();
            }
        });
        ...
        this.cbLiteral.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<OptionPair>(){
            ...
            public void changed(ObservableValue<? extends OptionPair> observableValue, OptionPair optionPair, OptionPair optionPair2) {
                if (optionPair2 != null && !StringProcess.isEmpty(optionPair2.getValue())) {
                    EstimateReport5Controller.this.cs56.setText(optionPair2.getAlias());
                }
            }
        });
    }
    ...
    private void initButton() {
        this.btFloorEffect.setOnAction((EventHandler)new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent actionEvent) {
                if (!(StringProcess.isEmpty(EstimateReport5Controller.this.cs02.getValue()) && StringProcess.isEmpty(EstimateReport5Controller.this.cs03.getValue()) || StringProcess.isEmpty(EstimateReport5Controller.this.cs04f.getValue()))) {
                    EstimateReport5Controller.this.createFloorEffect();
                } else {
        ...
        this.btAddLiteral.setOnAction((EventHandler)new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent actionEvent) {
                String string = EstimateReport5Controller.this.cs56.getText();
                if (!StringProcess.isEmpty(string)) {
                    GlossaryModel glossaryModel = new GlossaryModel();
                    glossaryModel.addLiteral(string, "SELL", "SELL_CS56");
                    glossaryModel.query("SELL", "SELL_CS56", 0, "");
                    EstimateReport5Controller.this.cbLiteral.setItems(FXCollections.observableArrayList(glossaryModel.getDataOptionpairs()));
                    EstimateReport5Controller.this.cbLiteral.getSelectionModel().selectLast();
                    JavaFXUtil.showToastMessageBox(EstimateReport5Controller.this.parentController.dialog.getStage(), "\u5df2\u65b0\u589e\u8fad\u5eab", 1500);
                }
            }
        });
        this.btPhotos.setOnAction(actionEvent -> {
            ...
            imageBrowserDialog.load("\u6210\u672c\u6cd5\u53ca\u623f\u5730\u5206\u96e2\u4f30\u50f9\u88683", "SELL3");
    ...
    private void initRadioButton() {
        this.havebuildN.selectedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (bl2.booleanValue()) {
                    EstimateReport5Controller.this.floorPart.setDisable(true);
                    EstimateReport5Controller.this.floorAll.setDisable(true);
                    EstimateReport5Controller.this.changeType(4);
                }
            }
        });
        this.havebuildY.selectedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (bl2.booleanValue()) {
                    EstimateReport5Controller.this.floorPart.setDisable(false);
                    EstimateReport5Controller.this.floorAll.setDisable(false);
                    if (EstimateReport5Controller.this.floorPart.isSelected()) {
                        EstimateReport5Controller.this.changeType(5);
                    } else if (EstimateReport5Controller.this.floorAll.isSelected()) {
                        EstimateReport5Controller.this.changeType(6);
                    }
                }
            }
        });
        this.floorPart.selectedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (bl2.booleanValue() && !EstimateReport5Controller.this.floorPart.isDisable()) {
                    EstimateReport5Controller.this.changeType(5);
                }
            }
        });
        ...
        this.CS04_1.selectedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (bl2.booleanValue()) {
                    EstimateReport5Controller.this.cs04f.setDisable(true);
                }
            }
        });
        this.CS04_2.selectedProperty().addListener((ChangeListener)new ChangeListener<Boolean>(){
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean bl, Boolean bl2) {
                if (bl2.booleanValue()) {
                    EstimateReport5Controller.this.cs04f.setDisable(false);
                }
            }
        });
    }
            ...
            if (this.model.voValue.containsKey(node.getId())) {
                if (node instanceof DecimalField) {
                    if (node.getStyleClass().contains((Object)"rp2_ch") && ((BigDecimal)(object2 = new BigDecimal((String)this.model.voValue.get(node.getId())))).compareTo((BigDecimal)(object = new BigDecimal(((DecimalField)node).getValue().toString()))) != 0) {
                        EstimateModel.col_update.put("as339_3", true);
                    }
    ...
    protected void updateUIFromVo() {
        ...
        for (String[] stringArray2 : this.report5.getChildren()) {
    ...
    private void changeType(int n) {
        ...
        EstimateModel.BASELANDBEAN.voSell_3.setSelltype(String.valueOf(n));
        if (n == 4) {
