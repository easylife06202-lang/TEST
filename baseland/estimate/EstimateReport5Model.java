...
public class EstimateReport5Model
extends Model {
    HashMap<String, Object> voValue = new HashMap();

    public void updateHashMapValues() {
        this.voValue = EstimateModel.BASELANDBEAN.voSell_3.getFieldToHashMapExport();
    }

    public void reCal() {
        NVO_BASELAND_SELL nVO_BASELAND_SELL = EstimateModel.BASELANDBEAN.voSell_3;
        NVO_BASELAND_APPRAISALA3_SCORE nVO_BASELAND_APPRAISALA3_SCORE = EstimateModel.BASELANDBEAN.voAppRaA3Vo3;
    ...
    public void updateVo() {
        EstimateModel.BASELANDBEAN.voSell_3.setBeanByHashMap(this.voValue, false);
    }
