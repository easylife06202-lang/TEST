...
public class EstimateReport3Model
extends Model {
    HashMap<String, Object> voValue = new HashMap();

    public void updateHashMapValues() {
        this.voValue = EstimateModel.BASELANDBEAN.voSell_1.getFieldToHashMapExport();
    }

    public void updateAppRaVo(NVO_BASELAND_SELL nVO_BASELAND_SELL, NVO_BASELAND_APPRAISALA3_SCORE nVO_BASELAND_APPRAISALA3_SCORE) {
    ...
    public void reCal() {
        NVO_BASELAND_SELL nVO_BASELAND_SELL = EstimateModel.BASELANDBEAN.voSell_1;
        NVO_BASELAND_APPRAISALA3_SCORE nVO_BASELAND_APPRAISALA3_SCORE = EstimateModel.BASELANDBEAN.voAppRaA3Vo1;
        new AutoCalBaseLandSell(nVO_BASELAND_SELL);
        this.updateAppRaVo(nVO_BASELAND_SELL, nVO_BASELAND_APPRAISALA3_SCORE);
        new EstimateReport2Model().calAppraisal();
    }

    public void updateVo() {
        EstimateModel.BASELANDBEAN.voSell_1.setBeanByHashMap(this.voValue, false);
    }
