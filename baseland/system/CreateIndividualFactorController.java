...
public class CreateIndividualFactorController {
    @FXML
    ...
    NVO_BASELAND_INDIVIDUAL_FACTOR vo = new NVO_BASELAND_INDIVIDUAL_FACTOR();
    String city;
    String dist;
    String year;
    String version;
    ...
    public void init(IndividualFactorModel individualFactorModel, String string, String string2, String string3, final String string4, String string5, String string6) {
        ...
        this.cbMainCode.setItems(FXCollections.observableArrayList(SQLiteDataProviderModel.getIndividualFactorMainCodeList(string4, this.mainCode)));
        ...
        this.cbMainCode.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<OptionPair>(){
            ...
            public void changed(ObservableValue<? extends OptionPair> observableValue, OptionPair optionPair, OptionPair optionPair2) {
                String string = null;
                if (CreateIndividualFactorController.this.cbMainCode.getSelectionModel().getSelectedItem() != null) {
                    string = ((OptionPair)CreateIndividualFactorController.this.cbMainCode.getSelectionModel().getSelectedItem()).getValue();
                }
                CreateIndividualFactorController.this.cbItemCode.setItems(FXCollections.observableArrayList(SQLiteDataProviderModel.getIndividualFactorItemList(string4, string)));
            }
        });
        ...
        this.cbDegree.getSelectionModel().selectedItemProperty().addListener((ChangeListener)new ChangeListener<OptionPair>(){
            ...
            public void changed(ObservableValue<? extends OptionPair> observableValue, OptionPair optionPair, OptionPair optionPair2) {
                ...
                if (optionPair2 != null) {
                    ...
                    if (n == 2) {
                        CreateIndividualFactorController.this.tfDnames.setText("\u512a,\u52a3");
                    } else if (n == 3) {
                        CreateIndividualFactorController.this.tfDnames.setText("\u512a,\u666e\u901a,\u52a3");
                    } else if (n == 5) {
                        CreateIndividualFactorController.this.tfDnames.setText("\u512a,\u7a0d\u512a,\u666e\u901a,\u7a0d\u52a3,\u52a3");
                    } else if (n == 7) {
                        CreateIndividualFactorController.this.tfDnames.setText("\u6975\u512a,\u512a,\u7a0d\u512a,\u666e\u901a,\u7a0d\u52a3,\u52a3,\u6975\u52a3");
                    } else if (n == 9) {
                        CreateIndividualFactorController.this.tfDnames.setText("\u8d85\u6975\u512a,\u6975\u512a,\u512a,\u7a0d\u512a,\u666e\u901a,\u7a0d\u52a3,\u52a3,\u6975\u52a3,\u8d85\u6975\u52a3");
                    } else {
                        CreateIndividualFactorController.this.tfDnames.setText("\u8acb\u8f38\u5165\u5404\u7b49\u7d1a\u540d\u7a31\uff0c\u4e26\u4ee5\u9017\u865f\u9694\u958b\u3002");
                    }
                }
            }
        });
        ...
        this.btOK.setOnAction((EventHandler)new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent actionEvent) {
                if (CreateIndividualFactorController.this.checkVo()) {
                    if (CreateIndividualFactorController.this.model.isExist(CreateIndividualFactorController.this.vo)) {
                        Node node = (Node)actionEvent.getSource();
                        Stage stage = (Stage)node.getScene().getWindow();
                        JavaFXUtil.showToastMessageBox(stage, "\u8cc7\u6599\u5df2\u5b58\u5728", 1500);
                        return;
                    }
                    String[] stringArray = CreateIndividualFactorController.this.vo.getDnames().split(",");
                    if (stringArray.length != CreateIndividualFactorController.this.vo.getDegree()) {
                        JavaFXUtil.showErrorMessageBox("\u7b49\u7d1a\u540d\u7a31\u6578\u91cf\u8207\u8a2d\u5b9a\u4e4b\u7b49\u7d1a\u4e0d\u7b26\uff0c\u8acb\u91cd\u65b0\u8f38\u5165", "\u7b49\u7d1a\u540d\u7a31\u8acb\u7528\u9017\u865f(,)\u9694\u958b\uff0c\u7b49\u7d1a\u540d\u7a31\u6578\u91cf\u9700\u8207\u8a2d\u5b9a\u7b49\u7d1a\u4e00\u81f4");
                        return;
                    }
                    CreateIndividualFactorController.this.model.save(CreateIndividualFactorController.this.vo, CreateIndividualFactorController.this.city, CreateIndividualFactorController.this.dist, CreateIndividualFactorController.this.year, CreateIndividualFactorController.this.version, CreateIndividualFactorController.this.baseno, CreateIndividualFactorController.this.mainCode);
                    Node node = (Node)actionEvent.getSource();
                    Stage stage = (Stage)node.getScene().getWindow();
                    stage.close();
                } else {
