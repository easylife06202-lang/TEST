...
public class NDAO_BASELAND_DEVELOP_EXT
extends DaoBase {
    public NDAO_BASELAND_DEVELOP_EXT() {
        this.fullClassName = "moiland.baseland.dataaccess.nvo.NVO_BASELAND_DEVELOP_EXT";
     ...
     */
    public NVO_BASELAND_DEVELOP_EXT findByPk(String string, String string2, Connection connection) throws Exception {
        String string3 = " SELECT * FROM BASELAND_DEVELOP_EXT WHERE BASENO=@@ AND YEAR=@@ ";
        ...
        try {
            ...
            if (this._rs.next()) {
                NVO_BASELAND_DEVELOP_EXT nVO_BASELAND_DEVELOP_EXT = (NVO_BASELAND_DEVELOP_EXT)this.getResults(this._rs);
