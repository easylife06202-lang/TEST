...
public class NDAO_BASELAND_INDIVIDUAL_FACTOR_STD
extends DaoBase {
    public NDAO_BASELAND_INDIVIDUAL_FACTOR_STD() {
        this.fullClassName = "moiland.baseland.dataaccess.nvo.NVO_BASELAND_INDIVIDUAL_FACTOR_STD";
        this.us = new Us7Ascii(false);
    }

    public ArrayList<NVO_BASELAND_INDIVIDUAL_FACTOR_STD> queryStdDataByItem(String string, String string2, String string3, String string4, String string5, String string6, Connection connection) throws Exception {
        String string7 = "SELECT * FROM BASELAND_INDIVIDUAL_FACTOR_STD WHERE CITY=@@ AND DIST=@@ AND YEAR=@@ AND VERSION=@@ AND BASENO=@@ AND ITEM=@@ ORDER BY LEVEL";
    ...
    public int clearStdDataByItem(String string, String string2, String string3, String string4, String string5, String string6, Connection connection) throws SQLException {
        String string7 = "DELETE FROM BASELAND_INDIVIDUAL_FACTOR_STD WHERE CITY=@@ AND DIST=@@ AND YEAR=@@ AND VERSION=@@ AND BASENO=@@ AND ITEM=@@";
        SqlBuilder sqlBuilder = new SqlBuilder(string7);
        int n = 0;
        sqlBuilder.setString(n++, string);
        sqlBuilder.setString(n++, string2);
    ...
    public int clearSpecificVersionByBaseno(String string, String string2, Connection connection) throws SQLException {
        String string3 = "DELETE FROM BASELAND_INDIVIDUAL_FACTOR_STD WHERE BASENO<>'' AND YEAR=@@ AND BASENO=@@";
    ...
    public ArrayList<NVO_BASELAND_INDIVIDUAL_FACTOR_STD> queryDataForCopyStd(String string, String string2, String string3, String string4, String string5, Connection connection) throws Exception {
        boolean bl = !StringProcess.isEmpty(string) && !StringProcess.isEmpty(string3) && !StringProcess.isEmpty(string2);
        ArrayList arrayList = new ArrayList();
        if (bl) {
            SqlBuilder sqlBuilder = new SqlBuilder();
            StringBuffer stringBuffer = new StringBuffer();
            ArrayList<String> arrayList2 = new ArrayList<String>();
            stringBuffer.append(" SELECT * FROM BASELAND_INDIVIDUAL_FACTOR_STD ");
    ...
    public ArrayList<NVO_BASELAND_INDIVIDUAL_FACTOR_STD> queryDeleteForCopyStd(String string, String string2, String string3, String string4, String string5, Connection connection) throws Exception {
        return this.queryDeleteForCopyStd(string, string2, string3, string4, string5, true, connection);
    }

    public ArrayList<NVO_BASELAND_INDIVIDUAL_FACTOR_STD> queryDeleteForCopyStd(String string, String string2, String string3, String string4, String string5, boolean bl, Connection connection) throws Exception {
        boolean bl2;
