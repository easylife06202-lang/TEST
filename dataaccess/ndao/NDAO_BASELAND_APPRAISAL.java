...
public class NDAO_BASELAND_APPRAISAL
extends DaoBase {
    public NDAO_BASELAND_APPRAISAL() {
        this.fullClassName = "moiland.baseland.dataaccess.nvo.NVO_BASELAND_APPRAISAL";
        this.us = new Us7Ascii(false);
    }

    public ArrayList<NVO_BASELAND_APPRAISAL> queryData(String string, String string2, Connection connection) throws Exception {
        ...
        if (bl) {
            ...
            stringBuffer.append("SELECT * FROM BASELAND_APPRAISAL WHERE year=@@ AND baseno=@@");
