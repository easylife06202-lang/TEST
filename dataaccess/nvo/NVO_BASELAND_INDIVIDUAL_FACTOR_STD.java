...
public class NVO_BASELAND_INDIVIDUAL_FACTOR_STD
extends VoBase
implements Serializable,
Cloneable,
FactorStdVoFace {
    private static final long serialVersionUID = 1465034047L;
    ...
    public NVO_BASELAND_INDIVIDUAL_FACTOR_STD() {
        this.tableName = "baseland_individual_factor_std";
    ...
    public Object clone() {
        ...
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.city = (DbString)this.city.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.dist = (DbString)this.dist.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.year = (DbString)this.year.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.version = (DbString)this.version.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.baseno = (DbString)this.baseno.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.item = (DbString)this.item.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.level = (DbInteger)this.level.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.none = (DbString)this.none.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.contents = (DbString)this.contents.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.a_symbol = (DbString)this.a_symbol.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.a_digital = (DbDouble)this.a_digital.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.ab_logic = (DbString)this.ab_logic.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.b_symbol = (DbString)this.b_symbol.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.b_digital = (DbDouble)this.b_digital.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.bc_logic = (DbString)this.bc_logic.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.c_symbol = (DbString)this.c_symbol.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.c_digital = (DbDouble)this.c_digital.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.cd_logic = (DbString)this.cd_logic.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.d_symbol = (DbString)this.d_symbol.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.d_digital = (DbDouble)this.d_digital.clone();
        dbElementArray[0] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.city;
        dbElementArray[1] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.dist;
        dbElementArray[2] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.year;
        dbElementArray[3] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.version;
        dbElementArray[4] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.baseno;
        dbElementArray[5] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.item;
        dbElementArray[6] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.level;
        dbElementArray[7] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.none;
        dbElementArray[8] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.contents;
        dbElementArray[9] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.a_symbol;
        dbElementArray[10] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.a_digital;
        dbElementArray[11] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.ab_logic;
        dbElementArray[12] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.b_symbol;
        dbElementArray[13] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.b_digital;
        dbElementArray[14] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.bc_logic;
        dbElementArray[15] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.c_symbol;
        dbElementArray[16] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.c_digital;
        dbElementArray[17] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.cd_logic;
        dbElementArray[18] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.d_symbol;
        dbElementArray[19] = nVO_BASELAND_INDIVIDUAL_FACTOR_STD.d_digital;
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.elems = dbElementArray;
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.fieldCount = this.fieldCount;
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.orderString = this.orderString;
        nVO_BASELAND_INDIVIDUAL_FACTOR_STD.tableName = this.tableName;
