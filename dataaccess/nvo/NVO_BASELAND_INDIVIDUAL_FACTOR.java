...
public class NVO_BASELAND_INDIVIDUAL_FACTOR
extends VoBase
implements Serializable,
Cloneable,
FactorMainVoFace {
    private static final long serialVersionUID = 1866295675L;
    ...
    public NVO_BASELAND_INDIVIDUAL_FACTOR() {
        this.tableName = "baseland_individual_factor";
    ...
    public Object clone() {
        ...
        nVO_BASELAND_INDIVIDUAL_FACTOR.city = (DbString)this.city.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.dist = (DbString)this.dist.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.year = (DbString)this.year.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.version = (DbString)this.version.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.baseno = (DbString)this.baseno.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.item = (DbString)this.item.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.impact = (DbInteger)this.impact.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.degree = (DbInteger)this.degree.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.dnames = (DbString)this.dnames.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.std_type = (DbString)this.std_type.clone();
        nVO_BASELAND_INDIVIDUAL_FACTOR.std_unit = (DbString)this.std_unit.clone();
        dbElementArray[0] = nVO_BASELAND_INDIVIDUAL_FACTOR.city;
        dbElementArray[1] = nVO_BASELAND_INDIVIDUAL_FACTOR.dist;
        dbElementArray[2] = nVO_BASELAND_INDIVIDUAL_FACTOR.year;
        dbElementArray[3] = nVO_BASELAND_INDIVIDUAL_FACTOR.version;
        dbElementArray[4] = nVO_BASELAND_INDIVIDUAL_FACTOR.baseno;
        dbElementArray[5] = nVO_BASELAND_INDIVIDUAL_FACTOR.item;
        dbElementArray[6] = nVO_BASELAND_INDIVIDUAL_FACTOR.impact;
        dbElementArray[7] = nVO_BASELAND_INDIVIDUAL_FACTOR.degree;
        dbElementArray[8] = nVO_BASELAND_INDIVIDUAL_FACTOR.dnames;
        dbElementArray[9] = nVO_BASELAND_INDIVIDUAL_FACTOR.std_type;
        dbElementArray[10] = nVO_BASELAND_INDIVIDUAL_FACTOR.std_unit;
        nVO_BASELAND_INDIVIDUAL_FACTOR.elems = dbElementArray;
        nVO_BASELAND_INDIVIDUAL_FACTOR.fieldCount = this.fieldCount;
        nVO_BASELAND_INDIVIDUAL_FACTOR.orderString = this.orderString;
        nVO_BASELAND_INDIVIDUAL_FACTOR.tableName = this.tableName;
